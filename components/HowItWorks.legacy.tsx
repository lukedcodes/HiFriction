// Archived — superseded by the emerald-themed HowItWorks (4 Layers) and the
// new Challenges section. Kept here in case we want to roll back.
import styles from "./HowItWorks.legacy.module.css";
